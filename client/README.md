...
### Pop up window for uploading image
<img src="./public/images/popup.png" alt="popup">

### Uploaded image display
Each uploaded image is formatted into a bootstrap card with a title, description, and link to its own page and displayed within a gallery on the screen
<img src="./public/images/image-upload.png" alt="image upload">

### Uploaded image displayed in MongoDB Atlas
...
<img src="./public/images/multiple-input.png" alt="multiple input">

### Display upon uploading multiple images
<img src="./public/images/multiple-output.png" alt="multiple output">
